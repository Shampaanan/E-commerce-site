...
--
-- Table structure for table `mm_operators`
--

CREATE TABLE `mm_operators` (
  `mm_id` int(11) NOT NULL,
  `mm_fullname` varchar(63) NOT NULL,
  `mm_address` varchar(255) NOT NULL,
  `mm_zip` varchar(7) NOT NULL,
  `mm_country` varchar(15) NOT NULL,
  `mm_email` varchar(63) NOT NULL,
  `mm_password` varchar(127) NOT NULL,
  `mm_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mm_operators`
--

INSERT INTO `mm_operators` (`mm_id`, `mm_fullname`, `mm_address`, `mm_zip`, `mm_country`, `mm_email`, `mm_password`, `mm_status`) VALUES
...
--
-- Indexes for table `mm_operators`
--
ALTER TABLE `mm_operators`
...
--
-- AUTO_INCREMENT for table `mm_operators`
--
ALTER TABLE `mm_operators`
