...
--
-- Database: `diu_shahanaz`
--

-- --------------------------------------------------------

--
-- Table structure for table `jj_operators`
--

CREATE TABLE `jj_operators` (
  `jj_id` int(11) NOT NULL,
  `jj_fullname` varchar(63) NOT NULL,
  `jj_address` varchar(255) NOT NULL,
  `jj_zip` varchar(7) NOT NULL,
  `jj_country` varchar(15) NOT NULL,
  `jj_email` varchar(63) NOT NULL,
  `jj_password` varchar(127) NOT NULL,
  `jj_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `jj_operators`
--

INSERT INTO `jj_operators` (`jj_id`, `jj_fullname`, `jj_address`, `jj_zip`, `jj_country`, `jj_email`, `jj_password`, `jj_status`) VALUES
...
--
-- Indexes for table `jj_operators`
--
ALTER TABLE `jj_operators`
  ADD PRIMARY KEY (`jj_id`);
...
--
-- AUTO_INCREMENT for table `jj_operators`
--
ALTER TABLE `jj_operators`
  MODIFY `jj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
