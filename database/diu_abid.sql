...
--
-- Host: localhost:8889
-- Generation Time: Apr 23, 2022 at 08:20 AM
...
--
-- Table structure for table `nn_operators`
--

CREATE TABLE `nn_operators` (
  `nn_id` int(11) NOT NULL,
  `nn_fullname` varchar(63) NOT NULL,
  `nn_address` varchar(255) NOT NULL,
  `nn_zip` varchar(7) NOT NULL,
  `nn_country` varchar(15) NOT NULL,
  `nn_email` varchar(63) NOT NULL,
  `nn_password` varchar(127) NOT NULL,
  `nn_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `nn_operators`
--

INSERT INTO `nn_operators` (`nn_id`, `nn_fullname`, `nn_address`, `nn_zip`, `nn_country`, `nn_email`, `nn_password`, `nn_status`) VALUES
...
--
-- Indexes for table `nn_operators`
--
ALTER TABLE `nn_operators`
...
--
-- AUTO_INCREMENT for table `nn_operators`
--
ALTER TABLE `nn_operators`
  MODIFY `nn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
