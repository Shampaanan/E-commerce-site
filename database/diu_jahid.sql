...
--
-- Table structure for table `gg_operators`
--

CREATE TABLE `gg_operators` (
  `gg_id` int(11) NOT NULL,
  `gg_fullname` varchar(63) NOT NULL,
  `gg_address` varchar(255) NOT NULL,
  `gg_zip` varchar(7) NOT NULL,
  `gg_country` varchar(15) NOT NULL,
  `gg_email` varchar(63) NOT NULL,
  `gg_password` varchar(127) NOT NULL,
  `gg_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `gg_operators`
--

INSERT INTO `gg_operators` (`gg_id`, `gg_fullname`, `gg_address`, `gg_zip`, `gg_country`, `gg_email`, `gg_password`, `gg_status`) VALUES
...
--
-- Indexes for table `gg_operators`
--
ALTER TABLE `gg_operators`
...
--
-- AUTO_INCREMENT for table `gg_operators`
--
ALTER TABLE `gg_operators`
  MODIFY `gg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
