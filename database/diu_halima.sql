...
--
-- Table structure for table `hh_operators`
--

CREATE TABLE `hh_operators` (
  `hh_id` int(11) NOT NULL,
  `hh_fullname` varchar(63) NOT NULL,
  `hh_address` varchar(255) NOT NULL,
  `hh_zip` varchar(7) NOT NULL,
  `hh_country` varchar(15) NOT NULL,
  `hh_email` varchar(63) NOT NULL,
  `hh_password` varchar(127) NOT NULL,
  `hh_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `hh_operators`
--

INSERT INTO `hh_operators` (`hh_id`, `hh_fullname`, `hh_address`, `hh_zip`, `hh_country`, `hh_email`, `hh_password`, `hh_status`) VALUES
...
--
-- Indexes for table `hh_operators`
--
ALTER TABLE `hh_operators`
...
--
-- AUTO_INCREMENT for table `hh_operators`
--
ALTER TABLE `hh_operators`
  MODIFY `hh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
