...
--
-- Table structure for table `cc_operators`
--

CREATE TABLE `cc_operators` (
  `cc_id` int(11) NOT NULL,
  `cc_fullname` varchar(63) NOT NULL,
  `cc_address` varchar(255) NOT NULL,
  `cc_zip` varchar(7) NOT NULL,
  `cc_country` varchar(15) NOT NULL,
  `cc_email` varchar(63) NOT NULL,
  `cc_password` varchar(127) NOT NULL,
  `cc_status` enum('Active','Inactive') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `cc_operators`
--

INSERT INTO `cc_operators` (`cc_id`, `cc_fullname`, `cc_address`, `cc_zip`, `cc_country`, `cc_email`, `cc_password`, `cc_status`) VALUES
...
--
-- Indexes for table `cc_operators`
--
ALTER TABLE `cc_operators`
...
--
-- AUTO_INCREMENT for table `cc_operators`
--
ALTER TABLE `cc_operators`
